...
(def base-headers {:user-agent "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36"})
...
(defn ^String url->html
  ...
  (-> (http/get url
                {:throw true :headers base-headers})
      :body))
